    ...
    <div className="inline-flex h-9 items-center rounded-lg bg-secondary/80 p-1 text-secondary-foreground no-srollbar w-full justify-start overflow-auto md:w-fit outline-none">
      {items.map((item, index) => (
        <Link key={index} href={item.disabled ? "#" : item.href}>
          <span
            className={cn(
              "mx-0.5 inline-flex items-center justify-center whitespace-nowrap rounded-md px-2.5 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow text-accent",
