...
const IndexPage = () => {
  return (
    <>
      ...
      <section id="credentials" className="container py-8 md:py-12 lg:py-24">
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            This is a remake of my university project but now using modern Next
            JS features like auth, API routes, and other technologies.
          </p>
        </div>
          ...
          <div className="relative overflow-hidden rounded-lg border bg-background p-2">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Same operations as the first version of the Digital O.B.
                </p>
              </div>
            </div>
          </div>
